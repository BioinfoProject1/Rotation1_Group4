...
# Merge pass files
cat /share/BioinfMSc/Matt_resources/long_reads/fastq_fail/barcode04/*.fastq.gz > $outdir/fail_merged_barcode04.fastq.gz

# Nanoplot
NanoPlot --fastq $outdir/fail_merged_barcode04.fastq.gz -o $outdir/failnanoplot_results
